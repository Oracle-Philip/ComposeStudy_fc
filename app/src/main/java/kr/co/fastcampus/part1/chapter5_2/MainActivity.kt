...
import kr.co.fastcampus.part1.chapter5_2.ui.theme.ViewModelTheme
...
class ToDoViewModel : ViewModel(){
    /**
     * viewModel의 생명주기와 Composable의 생명주기가 다르기 때문에
     * 더 이상 remember는 필요없다.
     * 구조분해는 local variables이나 values에서만 가능하다
     * 즉 지역변수는 가능하지만 viewmodel의 property는 어렵다
     */
    ...
    Scaffold {
        Column {
            ToDoInput(
                ...
                /**
                 * viewModel을 사용할 경우 lambda를 사용한다.
                 */
                onTextChange = {
